...
<body>
  ...
  <tr>
    ...
    <td style="padding:10px;"><a class="btn btn-danger" onclick="return confirm('are you sure to delete this')" href="{{url('cancel_appoint', $appoints->id)}}"> Cancel Appointment </a></td>
  </tr>
